...
static uint8_t second[6] = {0x0, 0x10, 0x20, 0x30, 0x40, 0x50}; //Array holding dynamic Alarm seconds field
volatile static uint8_t item = 0;
...
static void RTC_AlarmConfig(uint8_t seconds);
